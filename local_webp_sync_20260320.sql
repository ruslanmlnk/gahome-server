...
\restrict cc9bNt4c0UXwx2jiGWxmZojMocglcy06RJfvWmb05ClEvx5l7w6Ne6Ebo7LJuqI
...
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders DROP CONSTRAINT IF EXISTS pages_blocks_renders_parent_id_fk;
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders_items DROP CONSTRAINT IF EXISTS pages_blocks_renders_items_parent_id_fk;
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders_items DROP CONSTRAINT IF EXISTS pages_blocks_renders_items_main_image_id_media_id_fk;
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders_items_gallery DROP CONSTRAINT IF EXISTS pages_blocks_renders_items_gallery_parent_id_fk;
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders_items_gallery DROP CONSTRAINT IF EXISTS pages_blocks_renders_items_gallery_image_id_media_id_fk;
...
DROP INDEX IF EXISTS public.pages_blocks_renders_path_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_parent_id_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_order_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_items_parent_id_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_items_order_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_items_main_image_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_items_gallery_parent_id_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_items_gallery_order_idx;
DROP INDEX IF EXISTS public.pages_blocks_renders_items_gallery_image_idx;
...
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders DROP CONSTRAINT IF EXISTS pages_blocks_renders_pkey;
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders_items DROP CONSTRAINT IF EXISTS pages_blocks_renders_items_pkey;
ALTER TABLE IF EXISTS ONLY public.pages_blocks_renders_items_gallery DROP CONSTRAINT IF EXISTS pages_blocks_renders_items_gallery_pkey;
...
DROP TABLE IF EXISTS public.pages_blocks_renders_items_gallery;
DROP TABLE IF EXISTS public.pages_blocks_renders_items;
DROP TABLE IF EXISTS public.pages_blocks_renders;
...
--
-- Name: pages_blocks_renders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.pages_blocks_renders (
    _order integer NOT NULL,
    _parent_id integer NOT NULL,
    _path text NOT NULL,
    id character varying NOT NULL,
...
--
-- Name: pages_blocks_renders_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.pages_blocks_renders_items (
    _order integer NOT NULL,
    _parent_id character varying NOT NULL,
    id character varying NOT NULL,
...
--
-- Name: pages_blocks_renders_items_gallery; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.pages_blocks_renders_items_gallery (
    _order integer NOT NULL,
    _parent_id character varying NOT NULL,
    id character varying NOT NULL,
    image_id integer NOT NULL
...
1	best location Premium Land Lots Available near Poconos PA	\N	BEST LOCATION	2	LOCATION	8	Mortgage Programs	1	 Custom Home Visualization	9	Smart Cost Advantages	3	Our Clients	4	innovations 	10	2026-03-20 19:03:33.807+00	2025-10-28 21:55:26.44+00	double savings	11	/the-process
\.
...
1	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:44:13.081+00	\N	\N	3-1.webp	image/webp	47736	1280	719	50	50	\N
2	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:51:52.277+00	\N	\N	1-2.webp	image/webp	373704	2034	1140	50	50	\N
3	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:52:18.795+00	\N	\N	5-3.webp	image/webp	150904	1536	1024	50	50	\N
4	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:52:21.744+00	\N	\N	6-4.webp	image/webp	1054174	4096	2731	50	50	\N
6	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:52:25.104+00	\N	\N	f3f5c601af5650c7d162737b2b60da9ae47c9ac2-6.webp	image/webp	545610	2731	4096	50	50	\N
8	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:52:26.059+00	\N	\N	2-8.webp	image/webp	430980	1536	1024	50	50	\N
9	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:52:26.469+00	\N	\N	4-9.webp	image/webp	130934	1024	1024	50	50	\N
10	\N	2026-03-20 20:54:53.079+00	2025-10-28 21:55:23.702+00	\N	\N	7-10.webp	image/webp	466614	4096	3277	50	50	\N
11	\N	2026-03-20 20:54:53.079+00	2026-03-20 06:25:58.64+00	\N	\N	quantum-azure-11.webp	image/webp	14598	736	414	50	50	\N
12	\N	2026-03-20 20:54:53.079+00	2026-03-20 06:33:56.218+00	\N	\N	2-1-12.webp	image/webp	55036	1080	1080	50	50	\N
13	\N	2026-03-20 20:54:53.079+00	2026-03-20 06:34:17.901+00	\N	\N	3-1-13.webp	image/webp	58102	1080	1080	50	50	\N
14	\N	2026-03-20 20:54:53.079+00	2026-03-20 06:34:47.627+00	\N	\N	4-1-14.webp	image/webp	56622	1080	1080	50	50	\N
15	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:52.923+00	\N	\N	0002-15.webp	image/webp	852730	2880	1620	50	50	\N
16	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.12+00	\N	\N	0003-16.webp	image/webp	895224	2880	1620	50	50	\N
17	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.202+00	\N	\N	0004-17.webp	image/webp	645420	2880	1620	50	50	\N
18	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.317+00	\N	\N	0005-18.webp	image/webp	901070	2880	1620	50	50	\N
19	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.425+00	\N	\N	0006-19.webp	image/webp	669470	2880	1620	50	50	\N
20	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.595+00	\N	\N	0007-20.webp	image/webp	553214	2880	1620	50	50	\N
21	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.72+00	\N	\N	0008-21.webp	image/webp	532870	2880	1620	50	50	\N
22	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:53.844+00	\N	\N	0009-22.webp	image/webp	829976	2880	1620	50	50	\N
23	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:54+00	\N	\N	0010-23.webp	image/webp	639082	2880	1620	50	50	\N
24	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:54.109+00	\N	\N	0011-24.webp	image/webp	610966	2880	1620	50	50	\N
25	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:54.18+00	\N	\N	0000-25.webp	image/webp	834172	2880	1620	50	50	\N
26	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:43:54.292+00	\N	\N	0001-26.webp	image/webp	872492	2880	1620	50	50	\N
27	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:57:46.942+00	\N	\N	0006-1-27.webp	image/webp	200958	1901	1069	50	50	\N
28	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:13.573+00	\N	\N	0002-1-28.webp	image/webp	209822	1901	1069	50	50	\N
29	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:13.685+00	\N	\N	0003-1-29.webp	image/webp	220724	1901	1069	50	50	\N
30	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:13.812+00	\N	\N	0004-1-30.webp	image/webp	179660	1901	1069	50	50	\N
31	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:13.886+00	\N	\N	0005-1-31.webp	image/webp	228058	1901	1069	50	50	\N
32	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:13.954+00	\N	\N	0007-1-32.webp	image/webp	204050	1901	1069	50	50	\N
33	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:14.063+00	\N	\N	0008-1-33.webp	image/webp	216850	1901	1069	50	50	\N
34	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:14.158+00	\N	\N	0010-1-34.webp	image/webp	231012	1901	1069	50	50	\N
35	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:14.248+00	\N	\N	0011-1-35.webp	image/webp	207652	1901	1069	50	50	\N
36	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:14.346+00	\N	\N	0000-1-36.webp	image/webp	222732	1901	1069	50	50	\N
37	\N	2026-03-20 20:54:53.079+00	2026-03-20 08:58:14.444+00	\N	\N	0001-1-37.webp	image/webp	221894	1901	1069	50	50	\N
47	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:02:55.687+00	\N	\N	1-47.webp	image/webp	155068	1267	713	50	50	\N
48	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:03:16.857+00	\N	\N	2-48.webp	image/webp	143950	1267	713	50	50	\N
49	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:03:22.003+00	\N	\N	4-49.webp	image/webp	236818	1267	713	50	50	\N
50	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:03:28.641+00	\N	\N	5-50.webp	image/webp	307288	1267	713	50	50	\N
51	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:03:52.184+00	\N	\N	1-1-51.webp	image/webp	176286	1267	713	50	50	\N
52	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:04:33.13+00	\N	\N	2-1-52.webp	image/webp	244068	1267	713	50	50	\N
53	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:04:40.606+00	\N	\N	3-53.webp	image/webp	160494	1267	713	50	50	\N
54	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:04:46+00	\N	\N	4-1-54.webp	image/webp	232766	1267	713	50	50	\N
55	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:04:53.103+00	\N	\N	6-1-55.webp	image/webp	244314	1267	713	50	50	\N
56	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:05:40.616+00	\N	\N	4-2-56.webp	image/webp	701800	3840	2160	50	50	\N
57	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:06:28.026+00	\N	\N	5-1-57.webp	image/webp	720658	3840	2160	50	50	\N
58	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:07:35.334+00	\N	\N	6-58.webp	image/webp	704508	3840	2160	50	50	\N
59	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:07:59.261+00	\N	\N	6.1-59.webp	image/webp	1127310	3840	2160	50	50	\N
60	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:09:05.551+00	\N	\N	1-1-60.webp	image/webp	907964	3840	2160	50	50	\N
61	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:09:35.731+00	\N	\N	2-2-61.webp	image/webp	749410	3840	2160	50	50	\N
62	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:09:52.992+00	\N	\N	3-2-62.webp	image/webp	703926	3840	2160	50	50	\N
63	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:10:12.211+00	\N	\N	3.1-63.webp	image/webp	1372340	3840	2160	50	50	\N
64	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:10:33.603+00	\N	\N	4-3-64.webp	image/webp	1037430	3840	2160	50	50	\N
65	\N	2026-03-20 20:54:53.079+00	2026-03-20 09:10:50.051+00	\N	\N	4.2-65.webp	image/webp	832278	3840	2160	50	50	\N
66	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:17:18.1+00	\N	\N	horizontal-1-segment-66.webp	image/webp	359172	2667	1500	50	50	\N
67	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:17:35.611+00	\N	\N	horizontal-1-segment-white-67.webp	image/webp	378964	2667	1500	50	50	\N
68	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:17:41.2+00	\N	\N	horizontal-2-segment-68.webp	image/webp	371970	2667	1500	50	50	\N
69	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:17:53.159+00	\N	\N	horizontal-4-segment-69.webp	image/webp	390472	2667	1500	50	50	\N
70	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:17:58.544+00	\N	\N	vertical-1-segment-70.webp	image/webp	346336	2667	1500	50	50	\N
71	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:18:09.579+00	\N	\N	vertical-2-segment-71.webp	image/webp	348564	2667	1500	50	50	\N
72	\N	2026-03-20 20:54:53.079+00	2026-03-20 18:18:18.924+00	\N	\N	vertical-4-segment-72.webp	image/webp	349000	2667	1500	50	50	\N
\.
...
6	3D visualisation (customise your home for 0$)	3D visualisation\n(customise your home for 0$)	Custom Home Visualization	visualisation	9	\N	\N	2026-03-20 19:02:04.157+00	2025-10-28 22:47:04.308+00
\.
...
4	6	content	69bd8e948b895d8c9a82d757	Each concept can be <strong>fully customized</strong> to match your vision, lifestyle, and project\ngoals.\n<strong>Exterior Design and Façade Options</strong>\nDuring the design process, we explore <strong>multiple façade variations</strong> to determine the\narchitectural character of the home.\nClients can review different exterior concepts in the 3D model, including variations\nin:\n• façade materials\n• architectural forms\n• window configurations\n• structural accents and finishes\nThis allows you to compare design directions and select the exterior that best fits\nyour preferences. 	f	\N
6	6	content	69bd95508b895d8c9a82d769	All façade options are presented as part of the visualization process so you can\nclearly understand how the final home will look.\n\n<strong>Functions and Interior Planning</strong>\nIn addition to architectural design, we also plan the <strong>functional structure of the\nhome.</strong>\nYou can select and customize different features depending on how you plan to use the\nhouse.\nExamples include: \n• home office or studio\n• gym or wellness space\n• guest suites\n• extended living areas\n• storage and utility spaces\nEach option can be reviewed within the 3D model, allowing you to see how it\nintegrates into the overall layout.\nWe also provide clear information about how different features may influence the\n<strong>project scope and overall cost.</strong>\n\n<strong>Visualize the Final Home</strong>\nThe goal of this process is to give you a <strong>clear and realistic preview of your finished\nhome</strong> before construction begins.\nThe 3D model allows you to review:\n• the full exterior architecture\n• interior layout and spatial flow\n• materials and finishes\n• architectural composition and proportions\nBy the time construction begins, the entire home has already been carefully designed\nand reviewed.\n\n<strong>From Visualization to Construction</strong>\nOnce the design and visualization stage is complete, the project moves into\nconstruction with a clear and fully developed plan.\nBecause all major decisions have already been finalized during the digital design\nstage, the construction process becomes <strong>more efficient, predictable, and\ntransparent.</strong>\nThe result is a home that is <strong>fully customized to your vision and thoughtfully\nplanned before the first stage of building begins. </strong>	f	\N
\.
...
--
-- Data for Name: pages_blocks_renders; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.pages_blocks_renders (_order, _parent_id, _path, id, block_name) FROM stdin;
3	6	content	69bd08ea55b61c451b0a688d	\N
5	6	content	69bd8ef18b895d8c9a82d759	\N
\.


--
-- Data for Name: pages_blocks_renders_items; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.pages_blocks_renders_items (_order, _parent_id, id, main_image_id) FROM stdin;
1	69bd08ea55b61c451b0a688d	69bd08ed55b61c451b0a688f	26
2	69bd08ea55b61c451b0a688d	69bd0cbafc266a420314c0d0	37
3	69bd08ea55b61c451b0a688d	69bd0d2cfc266a420314c0e8	47
4	69bd08ea55b61c451b0a688d	69bd0d63fc266a420314c0f0	51
5	69bd08ea55b61c451b0a688d	69bd0db9fc266a420314c0fa	56
6	69bd08ea55b61c451b0a688d	69bd0e74fc266a420314c102	60
1	69bd8ef18b895d8c9a82d759	69bd8f168b895d8c9a82d75b	66
\.


--
-- Data for Name: pages_blocks_renders_items_gallery; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.pages_blocks_renders_items_gallery (_order, _parent_id, id, image_id) FROM stdin;
1	69bd08ed55b61c451b0a688f	69bd08f755b61c451b0a6891	25
2	69bd08ed55b61c451b0a688f	69bd090255b61c451b0a6893	24
3	69bd08ed55b61c451b0a688f	69bd090555b61c451b0a6895	23
4	69bd08ed55b61c451b0a688f	69bd090755b61c451b0a6897	22
5	69bd08ed55b61c451b0a688f	69bd090955b61c451b0a6899	21
6	69bd08ed55b61c451b0a688f	69bd090b55b61c451b0a689b	20
7	69bd08ed55b61c451b0a688f	69bd090d55b61c451b0a689d	19
8	69bd08ed55b61c451b0a688f	69bd092b55b61c451b0a689f	18
9	69bd08ed55b61c451b0a688f	69bd092d55b61c451b0a68a1	17
10	69bd08ed55b61c451b0a688f	69bd093955b61c451b0a68a3	15
1	69bd0cbafc266a420314c0d0	69bd0cc3fc266a420314c0d2	36
2	69bd0cbafc266a420314c0d0	69bd0cccfc266a420314c0d4	35
3	69bd0cbafc266a420314c0d0	69bd0cd2fc266a420314c0d6	34
4	69bd0cbafc266a420314c0d0	69bd0cd9fc266a420314c0d8	33
5	69bd0cbafc266a420314c0d0	69bd0ce0fc266a420314c0da	32
6	69bd0cbafc266a420314c0d0	69bd0ce2fc266a420314c0dc	31
7	69bd0cbafc266a420314c0d0	69bd0ce5fc266a420314c0de	30
8	69bd0cbafc266a420314c0d0	69bd0d03fc266a420314c0e2	29
9	69bd0cbafc266a420314c0d0	69bd0d0efc266a420314c0e4	28
10	69bd0cbafc266a420314c0d0	69bd0d14fc266a420314c0e6	27
1	69bd0d2cfc266a420314c0e8	69bd0d41fc266a420314c0ea	48
2	69bd0d2cfc266a420314c0e8	69bd0d44fc266a420314c0ec	49
3	69bd0d2cfc266a420314c0e8	69bd0d46fc266a420314c0ee	50
1	69bd0d63fc266a420314c0f0	69bd0d91fc266a420314c0f2	52
2	69bd0d63fc266a420314c0f0	69bd0d94fc266a420314c0f4	53
3	69bd0d63fc266a420314c0f0	69bd0d96fc266a420314c0f6	54
4	69bd0d63fc266a420314c0f0	69bd0d98fc266a420314c0f8	55
1	69bd0db9fc266a420314c0fa	69bd0df9fc266a420314c0fc	57
2	69bd0db9fc266a420314c0fa	69bd0dfcfc266a420314c0fe	58
3	69bd0db9fc266a420314c0fa	69bd0dfefc266a420314c100	59
1	69bd0e74fc266a420314c102	69bd0eb4fc266a420314c104	61
2	69bd0e74fc266a420314c102	69bd0eb7fc266a420314c106	62
3	69bd0e74fc266a420314c102	69bd0eb9fc266a420314c108	63
4	69bd0e74fc266a420314c102	69bd0ef7fc266a420314c10a	64
5	69bd0e74fc266a420314c102	69bd0efafc266a420314c10c	65
1	69bd8f168b895d8c9a82d75b	69bd8f2f8b895d8c9a82d75d	67
2	69bd8f168b895d8c9a82d75b	69bd8f318b895d8c9a82d75f	68
3	69bd8f168b895d8c9a82d75b	69bd8f338b895d8c9a82d761	69
4	69bd8f168b895d8c9a82d75b	69bd8f358b895d8c9a82d763	70
5	69bd8f168b895d8c9a82d75b	69bd8f598b895d8c9a82d765	71
6	69bd8f168b895d8c9a82d75b	69bd8f5b8b895d8c9a82d767	72
\.
...
1	dev	-1	2026-03-20 18:12:13.074+00	2025-10-28 21:26:55.885+00
\.
...
1	1	523415e7-9dd3-4aa2-8308-67dcedef1d08	2026-03-20 18:14:34.44+00	2026-03-20 20:14:34.44+00
\.
...
SELECT pg_catalog.setval('public.media_id_seq', 72, true);
...
SELECT pg_catalog.setval('public.payload_locked_documents_id_seq', 47, true);
...
SELECT pg_catalog.setval('public.payload_locked_documents_rels_id_seq', 85, true);
...
--
-- Name: pages_blocks_renders_items_gallery pages_blocks_renders_items_gallery_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders_items_gallery
    ADD CONSTRAINT pages_blocks_renders_items_gallery_pkey PRIMARY KEY (id);


--
-- Name: pages_blocks_renders_items pages_blocks_renders_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders_items
    ADD CONSTRAINT pages_blocks_renders_items_pkey PRIMARY KEY (id);


--
-- Name: pages_blocks_renders pages_blocks_renders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders
    ADD CONSTRAINT pages_blocks_renders_pkey PRIMARY KEY (id);
...
--
-- Name: pages_blocks_renders_items_gallery_image_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_items_gallery_image_idx ON public.pages_blocks_renders_items_gallery USING btree (image_id);


--
-- Name: pages_blocks_renders_items_gallery_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_items_gallery_order_idx ON public.pages_blocks_renders_items_gallery USING btree (_order);


--
-- Name: pages_blocks_renders_items_gallery_parent_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_items_gallery_parent_id_idx ON public.pages_blocks_renders_items_gallery USING btree (_parent_id);


--
-- Name: pages_blocks_renders_items_main_image_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_items_main_image_idx ON public.pages_blocks_renders_items USING btree (main_image_id);


--
-- Name: pages_blocks_renders_items_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_items_order_idx ON public.pages_blocks_renders_items USING btree (_order);


--
-- Name: pages_blocks_renders_items_parent_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_items_parent_id_idx ON public.pages_blocks_renders_items USING btree (_parent_id);


--
-- Name: pages_blocks_renders_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_order_idx ON public.pages_blocks_renders USING btree (_order);


--
-- Name: pages_blocks_renders_parent_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_parent_id_idx ON public.pages_blocks_renders USING btree (_parent_id);


--
-- Name: pages_blocks_renders_path_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX pages_blocks_renders_path_idx ON public.pages_blocks_renders USING btree (_path);
...
--
-- Name: pages_blocks_renders_items_gallery pages_blocks_renders_items_gallery_image_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders_items_gallery
    ADD CONSTRAINT pages_blocks_renders_items_gallery_image_id_media_id_fk FOREIGN KEY (image_id) REFERENCES public.media(id) ON DELETE SET NULL;


--
-- Name: pages_blocks_renders_items_gallery pages_blocks_renders_items_gallery_parent_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders_items_gallery
    ADD CONSTRAINT pages_blocks_renders_items_gallery_parent_id_fk FOREIGN KEY (_parent_id) REFERENCES public.pages_blocks_renders_items(id) ON DELETE CASCADE;


--
-- Name: pages_blocks_renders_items pages_blocks_renders_items_main_image_id_media_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders_items
    ADD CONSTRAINT pages_blocks_renders_items_main_image_id_media_id_fk FOREIGN KEY (main_image_id) REFERENCES public.media(id) ON DELETE SET NULL;


--
-- Name: pages_blocks_renders_items pages_blocks_renders_items_parent_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders_items
    ADD CONSTRAINT pages_blocks_renders_items_parent_id_fk FOREIGN KEY (_parent_id) REFERENCES public.pages_blocks_renders(id) ON DELETE CASCADE;


--
-- Name: pages_blocks_renders pages_blocks_renders_parent_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_renders
    ADD CONSTRAINT pages_blocks_renders_parent_id_fk FOREIGN KEY (_parent_id) REFERENCES public.pages(id) ON DELETE CASCADE;
...
\unrestrict cc9bNt4c0UXwx2jiGWxmZojMocglcy06RJfvWmb05ClEvx5l7w6Ne6Ebo7LJuqI
